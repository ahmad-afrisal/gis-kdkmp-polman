                ...
                function previewImage(input) {
                    ...
                    if (input.files && input.files[0]) {
                        ...
                        reader.onload = function(e) {
                            ...
                            placeholderText.classList.add('opacity-0');
                        }
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form action="{{ route('commodities.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" placeholder="Masukkan deskripsi komoditas..." rows="4"
                                class="block w-full bg-gray-100 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-green-500">{{ old('description') }}</textarea>
                        </div>

                        <div class="flex space-x-2">
                            <button type="submit"
                                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-lg transition">
                                Simpan
                            </button>
