            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">Performa</span>
                    </nav>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6 flex flex-col items-center text-center h-full">
                            <!-- Foto -->
                            <img src="{{ asset('images/foto-ba/yusuf.png') }}" alt="Business Assistant"
                                class="w-24 h-24 rounded-full object-cover mb-4">

                            <!-- Nama -->
                            <h3 class="text-lg font-semibold">
                                {{ $bussinessAssistant->name }}
                            </h3>
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6 h-full flex flex-col items-center text-center">
                            ...
                            <p class="text-2xl font-bold {{ $kpiColor }} mb-6">
                                {{ $kpi }}
                            </p>
