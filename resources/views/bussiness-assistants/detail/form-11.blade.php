                                ...
                                <table class="min-w-full text-sm text-center border-collapse">
                                    ...
                                    <tbody class="text-gray-700">
                                        @forelse ($cooperations as $index => $coop)
                                            @php
                                                $form = $coop->formEleven; // Bisa null, aman
                                            @endphp
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-green-50 transition">
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        value="1"
                                                        {{ $form?->potential_partners === 1 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="potential_partners_{{ $index }}"
                                                        ...
                                                        value="0"
                                                        {{ $form?->potential_partners === 0 ? 'checked' : '' }}>
                                                </td>
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <select name="data[{{ $index }}][partnership_pattern]"
                                                        ...
                                                        <option value="inti-plasma"
                                                            {{ $form?->partnership_pattern == 'inti-plasma' ? 'selected' : '' }}>
                                                            inti-plasma
                                                        </option>
                                                        <option value="subkontrak"
                                                            {{ $form?->partnership_pattern == 'subkontrak' ? 'selected' : '' }}>
                                                            subkontrak</option>
                                                        <option value="waralaba"
                                                            {{ $form?->partnership_pattern == 'waralaba' ? 'selected' : '' }}>
                                                            waralaba
                                                        </option>
                                                        <option value="perdagangan umum"
                                                            {{ $form?->partnership_pattern == 'perdagangan umum' ? 'selected' : '' }}>
                                                            perdagangan umum</option>
                                                        <option value="subkontrak"
                                                            {{ $form?->partnership_pattern == 'subkontrak' ? 'selected' : '' }}>
                                                            subkontrak</option>
                                                        <option value="distribusi dan keagenan"
                                                            {{ $form?->partnership_pattern == 'distribusi dan keagenan' ? 'selected' : '' }}>
                                                            distribusi dan keagenan
                                                        </option>
                                                        <option value="rantai pasok"
                                                            {{ $form?->partnership_pattern == 'rantai pasok' ? 'selected' : '' }}>
                                                            rantai pasok</option>
                                                        <option value="bagi hasil"
                                                            {{ $form?->partnership_pattern == 'bagi hasil' ? 'selected' : '' }}>
                                                            bagi hasil</option>
                                                        <option value="kerja sama operasional"
                                                            {{ $form?->partnership_pattern == 'kerja sama operasional' ? 'selected' : '' }}>
                                                            kerja sama operasional</option>
                                                        <option value="usaha patungan (joint venture)"
                                                            {{ $form?->partnership_pattern == 'usaha patungan (joint venture)' ? 'selected' : '' }}>
                                                            usaha patungan (joint venture)</option>
                                                        <option value="penyumberluaran (outsourcing)"
                                                            {{ $form?->partnership_pattern == 'penyumberluaran (outsourcing)' ? 'selected' : '' }}>
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <select name="data[{{ $index }}][commodity_id]"
                                                        ...
                                                        @foreach ($commodities as $id => $name)
                                                            <option value="{{ $id }}"
                                                                {{ old("data.$index.commodity_id", $form?->commodity_id) == $id ? 'selected' : '' }}>
                                                                {{ $id }} - {{ $name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <select name="data[{{ $index }}][capacity]"
                                                        ...
                                                        <optgroup label="Berat">
                                                            <option value="kg"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'kg' ? 'selected' : '' }}>
                                                                Kilogram (kg)</option>
                                                            <option value="gr"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'gr' ? 'selected' : '' }}>
                                                                Gram (gr)</option>
                                                            <option value="ton"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'ton' ? 'selected' : '' }}>
                                                                Ton</option>
                                                            <option value="kw"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'kw' ? 'selected' : '' }}>
                                                                Kuintal (kw)</option>
                                                            <option value="lb"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'lb' ? 'selected' : '' }}>
                                                                Pound (lb)</option>
                                                        </optgroup>

                                                        <optgroup label="Kuantitas/Unit">
                                                            <option value="pcs"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'pcs' ? 'selected' : '' }}>
                                                                Pieces (pcs)</option>
                                                            <option value="btg"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'btg' ? 'selected' : '' }}>
                                                                Batang (btg)</option>
                                                            <option value="bks"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'bks' ? 'selected' : '' }}>
                                                                Bungkus (bks)</option>
                                                            <option value="unit"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'unit' ? 'selected' : '' }}>
                                                                Unit</option>
                                                            <option value="lsn"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'lsn' ? 'selected' : '' }}>
                                                                Lusin</option>
                                                        </optgroup>

                                                        <optgroup label="Volume/Cair">
                                                            <option value="lt"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'lt' ? 'selected' : '' }}>
                                                                Liter (lt)</option>
                                                            <option value="ml"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'ml' ? 'selected' : '' }}>
                                                                Mililiter (ml)</option>
                                                            <option value="m3"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'm3' ? 'selected' : '' }}>
                                                                Meter Kubik (m³)</option>
                                                        </optgroup>

                                                        <optgroup label="Luas/Panjang">
                                                            <option value="m"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'm' ? 'selected' : '' }}>
                                                                Meter (m)</option>
                                                            <option value="ha"
                                                                {{ old('capacity', $form?->capacity ?? '') == 'ha' ? 'selected' : '' }}>
                                                                Hektar (ha)</option>
                                                        </optgroup>
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        value="0"
                                                        {{ $form?->partnership_status == 0 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="partnership_status_{{ $index }}"
                                                        ...
                                                        value="1"
                                                        {{ $form?->partnership_status == 1 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="partnership_status_{{ $index }}"
                                                        ...
                                                        value="1"
                                                        {{ $form?->partnership_status == 2 ? 'checked' : '' }}>
                                                </td>

                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="output_{{ $index }}" data-type="disetujui"
                                                        name="data[{{ $index }}][output_approved]"
                                                        value="1" {{ $form?->output === 1 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="output_{{ $index }}" data-type="ditolak"
                                                        name="data[{{ $index }}][output_rejected]"
                                                        value="0" {{ $form?->output === 0 ? 'checked' : '' }}>
                                                </td>
