            ...
            <div class="py-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">Form 1</span>
                    </nav>
                    @if (session('error'))
                    ...
                    <div class="bg-white shadow-xl rounded-lg p-6">
                        ...
                        <form action="{{ route('bussiness-assistants.form-1.store', $bussinessAssistant->id) }}"
                            method="POST">
                            @csrf
                                ...
                                <table class="min-w-full text-sm text-center border-collapse">
                                    ...
                                    <thead>
                                        <tr class="bg-green-600 ">
                                            ...
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Pendaftaran Akun
                                            </th>
                                            <th colspan="3" class="border border-gray-300 px-3 py-2">Profil Koperasi
                                            </th>
                                        ...
                                        <tr class="bg-green-700 ">
                                            ...
                                            <th class="min-w-[70px] border border-gray-300 px-3 py-2">Berita Acara
                                                Musdes/Muskalus</th>
                                            <th class="min-w-[70px] border border-gray-300 px-3 py-2">Berita Acara Rapat
                                                Anggota
                                            </th>
                                            <th class="w-[800px] min-w-[300px] border border-gray-300 px-3 py-2">SK AHU
                                                Koperasi
                                            </th>
                                            ...
                                            <th class="w-[800px] min-w-[300px] border border-gray-300 px-3 py-2">Terisi
                                            </th>
                                            ...
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-green-50 transition">
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        name="data[{{ $index }}][sudah_terdaftar]"
                                                        value="1" {{ $coop->microsite_account ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="{{ $index }}" data-type="belum"
                                                        name="data[{{ $index }}][belum_terdaftar]"
                                                        value="1"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <select name="data[{{ $index }}][ba_musdes]"
                                                        ...
                                                        <option value="1"
                                                            {{ $coop->ba_musdes == 1 ? 'selected' : '' }}>
                                                            Ada
                                                        </option>
                                                        <option value="0"
                                                            {{ $coop->ba_musdes == 0 ? 'selected' : '' }}>
                                                            Belum Ada</option>
                                                    </select>
                                                </td>
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox"
                                                        ...
                                                        value="1"
                                                        {{ $coop->village_pharmacy_outlet ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox"
                                                        name="data[{{ $index }}][village_clinic_outlet]"
                                                        value="1"
                                                        {{ $coop->village_clinic_outlet ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox"
                                                        name="data[{{ $index }}][savings_and_loan_outlet]"
                                                        value="1"
                                                        {{ $coop->savings_and_loan_outlet ? 'checked' : '' }}>
                                                </td>

                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox"
                                                        name="data[{{ $index }}][cold_storage_outlet]"
                                                        value="1"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        name="data[{{ $index }}][tersedia_akun]"
                                                        value="1" {{ $coop->bank_account ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        data-group="bank_{{ $index }}" data-type="belum"
                                                        name="data[{{ $index }}][belum_tersedia_akun]"
                                                        value="1" {{ !$coop->bank_account ? 'checked' : '' }}>
                                                </td>
