            ...
            <div class="py-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">Form 3</span>
                    </nav>
                    @if (session('error'))
                    ...
                    <div class="bg-white shadow-xl rounded-lg p-6">
                        ...
                        <form action="{{ route('bussiness-assistants.form-3.store', $bussinessAssistant->id) }}"
                            method="POST">
                            @csrf
                                ...
                                <table class="min-w-full text-sm text-center border-collapse">
                                    ...
                                    <thead>
                                        <tr class="bg-green-600 ">
                                            ...
                                            <th colspan="10" class="border border-gray-300 px-3 py-2">Dokumen
                                                Kelengkapan
                                                Proposal</th>
                                        </tr>
                                        <tr class="bg-green-700 ">
                                            ...
                                            <th class="w-[500px] min-w-[300px] border border-gray-300 px-3 py-2">
                                                Keterangan
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="text-gray-700">
                                        @forelse ($cooperations as $index => $coop)
                                            ...
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-green-50 transition">
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <input type="text"
                                                        name="data[{{ $index }}][financing_partner]"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][cooperative_nik]"
                                                        value="1" {{ $form?->cooperative_nik ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][cooperative_bank_account]"
                                                        value="1"
                                                        {{ $form?->cooperative_bank_account ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][business_activity_plan]"
                                                        value="1"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][other_equipment]"
                                                        value="1" {{ $form?->other_equipment ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <input type="text"
