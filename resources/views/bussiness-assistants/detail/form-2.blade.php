            ...
            <div class="py-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">Form 2</span>
                    </nav>
                    @if (session('error'))
                    ...
                    <div class="bg-white shadow-xl rounded-lg p-6">
                        ...
                        <form action="{{ route('bussiness-assistants.form-2.store', $bussinessAssistant->id) }}"
                            method="POST">
                            @csrf
                                ...
                                <table class="min-w-full text-sm text-center border-collapse">
                                    ...
                                    <thead>
                                        <tr class="bg-green-600 ">
                                            ...
                                            <th rowspan="3"
                                                class="w-[500px] min-w-[300px] border border-gray-300 px-2 py-1">
                                                Rencana Bisnis
                                            </th>
                                        ...
                                        <tr class="bg-green-600 ">
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Pengadaan
                                                Sembako
                                            </th>
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Usaha Simpan
                                                Pinjam
                                            </th>
                                            ...
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Cold Storage/
                                                Pergudangan</th>
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Kegiatan Usaha
                                                Lain
                                            </th>
                                        </tr>
                                    ...
                                    <tbody class="text-gray-700">
                                        @forelse ($cooperations as $index => $coop)
                                            ...
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-green-50 transition">
                                                ...
                                                <td class="border border-gray-300 px-2 py-1">
                                                    <input type="text"
                                                        name="data[{{ $index }}][bussiness_plan]"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        value="1"
                                                        {{ $form?->basic_necessities_exist ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][pharmacy_exist]"
                                                        value="1" {{ $form?->pharmacy_exist ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][pharmacy_running]"
                                                        value="1"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][clinic_running]"
                                                        value="1" {{ $form?->clinic_running ? 'checked' : '' }}>
                                                </td>

                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][logistics_exist]"
                                                        value="1" {{ $form?->logistics_exist ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][logistics_running]"
                                                        value="1"
                                                        {{ $form?->logistics_running ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][storage_exist]"
                                                        value="1" {{ $form?->storage_exist ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][storage_running]"
                                                        value="1" {{ $form?->storage_running ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        name="data[{{ $index }}][other_businesses_exist]"
                                                        value="1"
                                                        {{ $form?->other_businesses_exist ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
