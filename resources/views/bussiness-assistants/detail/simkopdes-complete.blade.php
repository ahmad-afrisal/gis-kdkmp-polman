    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl rounded-lg p-6">
                ...
                <form action="{{ route('bussiness-assistants.simkopdes-completeness.store', $bussinessAssistant->id) }}"
                        ...
                        <table class="min-w-full text-sm text-center border-collapse">
                            ...
                            <thead>
                                <tr class="bg-green-600 ">
                                    ...
                                    <th class=" min-w-[130px] border border-gray-300 px-3 py-2">Link Profile</th>
