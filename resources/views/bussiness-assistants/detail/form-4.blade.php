            ...
            <div class="py-8">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">Form 4</span>
                    </nav>
                    @if (session('error'))
                    ...
                    <div class="bg-white shadow-xl rounded-lg p-6">
                        ...
                        <form action="{{ route('bussiness-assistants.form-4.store', $bussinessAssistant->id) }}"
                            method="POST">
                            @csrf
                                ...
                                <table class="min-w-full text-sm text-center border-collapse">
                                    ...
                                    <thead>
                                        <tr class="bg-green-600 ">
                                            ...
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Proposal
                                                Pembiayaan
                                            </th>
                                            <th rowspan="2" class="border border-gray-300 px-3 py-2">Tanggal
                                                Pengajuan
                                                Proposal Pembiayaan</th>
                                            <th colspan="2" class="border border-gray-300 px-3 py-2">Status Proposal
                                            </th>
                                            <th rowspan="2"
                                            ...
                                            <tr class="odd:bg-gray-50 even:bg-white hover:bg-green-50 transition">
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        name="data[{{ $index }}][financing_proposal_ada]"
                                                        value="1"
                                                ...
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        value="1"
                                                        {{ $form?->proposal_status === 0 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-2 py-1 text-center">
                                                    <input type="checkbox" class="checkbox-status"
                                                        ...
                                                        value="1"
                                                        {{ $form?->proposal_status === 1 ? 'checked' : '' }}>
                                                </td>

                                                <td class="border border-gray-300 px-2 py-1">
                                                    <input type="number"
                                                        name="data[{{ $index }}][financing_amount]"
