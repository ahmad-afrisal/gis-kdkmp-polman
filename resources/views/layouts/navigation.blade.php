    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('bussiness-assistants.index')" :active="request()->routeIs('bussiness-assistants.*')">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cooperations.index')" :active="request()->routeIs('cooperations.*')">
                        {{ __('Koperasi') }}
                    </x-nav-link>
                </div>
