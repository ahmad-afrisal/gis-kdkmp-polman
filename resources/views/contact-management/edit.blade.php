            ...
            <div class="py-12">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <nav class="flex items-center text-sm text-gray-600 space-x-2 mb-7">
                        ...
                        <span>›</span>
                        <span class="text-gray-500">{{ $data->cooperation_id }}</span>
                    </nav>
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('contact-managements.update', $data->id) }}" method="post"
                        ...
                        <input type="text" name="leader_name" value="{{ old('leader_name') ?? $data->leader_name }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Kontak Ketua : </label>
                        <input type="text" name="leader_phone_number"
                            value="{{ old('leader_phone_number') ?? $data->leader_phone_number }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Wakil Ketua Bidang Anggota : </label>
                        <input type="text" name="name_of_deputy_member"
                            value="{{ old('name_of_deputy_member') ?? $data->name_of_deputy_member }}"
                            class="w-full border
                    rounded p-2 mb-4">
                        ...
                        <input type="text" name="deputy_member_phone_number"
                            value="{{ old('deputy_member_phone_number') ?? $data->deputy_member_phone_number }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Wakil Ketua Bidang Usaha : </label>
                        <input type="text" name="name_of_deputy_business"
                            value="{{ old('name_of_deputy_business') ?? $data->name_of_deputy_business }}"
                            class="w-full border
                    rounded p-2 mb-4">
                        ...
                        <input type="text" name="deputy_business_phone_number"
                            value="{{ old('deputy_business_phone_number') ?? $data->deputy_business_phone_number }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Sekretaris : </label>
                        <input type="text" name="name_of_secretary"
                            value="{{ old('name_of_secretary') ?? $data->name_of_secretary }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Kontak Sekretaris: </label>
                        <input type="text" name="secretary_phone_number"
                            value="{{ old('secretary_phone_number') ?? $data->secretary_phone_number }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Bendahara : </label>
                        <input type="text" name="name_of_treasurer"
                            value="{{ old('name_of_treasurer') ?? $data->name_of_treasurer }}"
                            class="w-full border
                    rounded p-2 mb-4">

                        <label class="block mb-2 font-medium">Kontak Bendahara: </label>
                        <input type="text" name="treasurer_phone_number"
                            value="{{ old('treasurer_phone_number') ?? $data->treasurer_phone_number }}"
                            class="w-full border
                    rounded p-2 mb-4">
